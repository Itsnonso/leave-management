...
namespace leave_management.Repository
{
    public class UnitofWork : IUnitofWork
    {
        ...
        private  GenericRepository<LeaveType> _leaveTypes;
        private  GenericRepository<LeaveRequest> _leaveRequests;
        private  GenericRepository<LeaveAllocation> _leaveAllocations;
